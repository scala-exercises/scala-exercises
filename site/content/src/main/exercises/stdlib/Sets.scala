...
object Sets extends FlatSpec with Matchers with exercise.Section {
  ...
  /** easilyAddedSets
    ...
    */
  def easilyAddedSets(res0: String, res1: String) {
    val mySet = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
  ...
  /** mixedTypeSets
    ...
    */
  def mixedTypeSets(res0: String, res1: String) {
  ...
  /** checkExistenceSets
    ...
    */
  def checkExistenceSets(res0: String, res1: String) {
    val mySet = Set("Michigan", "Ohio", 12)
  ...
  /** easilyRemovedSets
    ...
    */
  def easilyRemovedSets(res0: String, res1: String) {
    val mySet = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
  ...
  /** multipleRemovingSets
    ...
    */
  def multipleRemovingSets(res0: String, res1: String, res2: String) {
    val mySet = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
  ...
  /** tupleRemovingSets
    ...
    */
  def tupleRemovingSets(res0: String, res1: String, res2: String) {
    val mySet = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
  ...
  /** nonexistentRemovalSets
    ...
    */
  def nonexistentRemovalSets(res0: String) {
    val mySet = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
  ...
  /** easilyIteratedSets
    ...
    */
  def easilyIteratedSets(res0: String) {
  ...
  /** easilyIntersectedSets
    ...
    */
  def easilyIntersectedSets(res0: String) {
  ...
  /** easilyJoinedSets
    ...
    */
  def easilyJoinedSets(res0: String) {
    val mySet1 = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
    val mySet2 = Set("Wisconsin", "Michigan", "Minnesota")
  ...
  /** subsetSets
    ...
    */
  def subsetSets(res0: String, res1: String) {
    val mySet1 = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
    val mySet2 = Set("Wisconsin", "Michigan", "Minnesota")
  ...
  /** easilyObtainedDifferencesSets
    ...
    */
  def easilyObtainedDifferencesSets(res0: String) {
    val mySet1 = Set("Michigan", "Ohio", "Wisconsin", "Iowa")
  ...
  /** equivalencySets
    ...
    */
  def equivalencySets(res0: String) {
    val mySet1 = Set("Michigan", "Ohio", "Wisconsin", "Iowa")

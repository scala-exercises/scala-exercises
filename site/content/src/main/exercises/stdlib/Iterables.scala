...
object Iterables extends FlatSpec with Matchers with exercise.Section {
  ...
  /** collectionIterablesIterables
    ...
    *
    */
  def collectionIterablesIterables(res0: String) {
  ...
  /** groupedIterables
    ...
    */
  def groupedIterables(res0: String, res1: String, res2: String, res3: String, res4: String, res5: String, res6: String, res7: String, res8: String) {
  ...
  /** slidingIterables
    ...
    */
  def slidingIterables(res0: String, res1: String, res2: String, res3: String, res4: String, res5: String, res6: String, res7: String, res8: String) {
    val list = List(3, 5, 9, 11, 15, 19, 21, 24, 32)
  ...
  /** slidingWindowIterables
    ...
    */
  def slidingWindowIterables(res0: String, res1: String, res2: String, res3: String, res4: String, res5: String, res6: String, res7: String, res8: String) {
    val list = List(3, 5, 9, 11, 15, 19, 21, 24, 32)
  ...
  /** zipIterables
    ...
    */
  def zipIterables(res0: String, res1: String, res2: String, res3: String, res4: String, res5: String) {
    val xs = List(3, 5, 9)
  ...
  /** sameSizeZipIterables
    ...
    *
    */
  def sameSizeZipIterables(res0: String, res1: String, res2: String, res3: String) {
    val xs = List(3, 5, 9)
    val ys = List("Bob", "Ann")
  ...
  /** zipAllIterables
    ...
    */
  def zipAllIterables(res0: String, res1: String, res2: String, res3: String, res4: String, res5: String, res6: String, res7: String, res8: String, res9: String) {
    val xs = List(3, 5, 9)
    val ys = List("Bob", "Ann")
  ...
  /** sameElementsIterables
    ...
    */
  def sameElementsIterables(res0: String, res1: String, res2: String, res3: String) {
    val xs = List("Manny", "Moe", "Jack")
    val ys = List("Manny", "Moe", "Jack")
    (xs sameElements ys) should be(res0)

    val xr = List("Manny", "Moe", "Jack")
    val yr = List("Manny", "Jack", "Moe")
    (xr sameElements yr) should be(res1)
    ...
    val xr1 = Set(1, 2, 3)
    val yr1 = Set(3, 2, 1)
    (xr1 sameElements yr1) should be(res3) // Caution - see below!

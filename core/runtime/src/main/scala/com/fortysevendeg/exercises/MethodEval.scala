...
class MethodEval(
  ...
  private val evaluator = new Evaluator(artifacts, scalacOptions, security, timeout)

  def eval[T](qualifiedMethod: String, rawArgs: List[String], imports: List[String] = Nil): EvaluationResult[T] = {

...
class CompilerSpec extends FunSpec with Matchers {
  ...
  val metaInfoCode = """
      ...
      case object LibMetaInfo extends org.scalaexercises.definitions.BuildInfo {
        ...
        override val toString: String = {
          "resolvers: %s, libraryDependencies: %s" format (
            resolvers, libraryDependencies
            )
        }
      }
                     """
  ...
  describe("library compilation") {
    it("works") {
      ...
      val path = "(internal)"
      val res = Compiler().compile(library, code :: Nil, path :: Nil, metaInfo, "/", "sample", fetchContributors = false)
